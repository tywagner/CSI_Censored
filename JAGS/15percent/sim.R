...
# NUmber of parameters to compare (int, slope, sigma)
# Hold MCMC for intercept
outDiff[i,1,1] <- out$BUGSoutput$mean$a - a
# Hold MCMC for slope
outDiff[i,2,1] <- out$BUGSoutput$mean$b - b
# Hold MCMC for sigma
outDiff[i,3,1] <- out$BUGSoutput$mean$sigma - sigma

outDiff[i,1,2] <- out0.5$BUGSoutput$mean$a - a
# Hold MCMC for slope
outDiff[i,2,2] <- out0.5$BUGSoutput$mean$b - b
# Hold MCMC for sigma
outDiff[i,3,2] <- out0.5$BUGSoutput$mean$sigma - sigma

outDiff[i,1,3] <- outDL$BUGSoutput$mean$a - a
# Hold MCMC for slope
outDiff[i,2,3] <- outDL$BUGSoutput$mean$b - b
# Hold MCMC for sigma
outDiff[i,3,3] <- outDL$BUGSoutput$mean$sigma - sigma

outDiff[i,1,4] <- out0$BUGSoutput$mean$a - a
# Hold MCMC for slope
outDiff[i,2,4] <- out0$BUGSoutput$mean$b - b
# Hold MCMC for sigma
outDiff[i,3,4] <- out0$BUGSoutput$mean$sigma - sigma

outDiff[i,1,5] <- outDrop$BUGSoutput$mean$a - a
# Hold MCMC for slope
outDiff[i,2,5] <- outDrop$BUGSoutput$mean$b - b
# Hold MCMC for sigma
outDiff[i,3,5] <- outDrop$BUGSoutput$mean$sigma - sigma
...
saveRDS(mean.diff2, "mean15percent.rds")
saveRDS(quant.diff2, "quant15percent.rds")

# #####################################################
# ########### PLOT ####################################
# #####################################################
res <- 6
name_figure <- "SimDiff15PerJAGS.jpg"
